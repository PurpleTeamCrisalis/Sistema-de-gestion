...
function TaxModal({ tax, setTax }) {
  ...
  return (
    <div className="divCharge">
      ...
      <button
        type="button"
        className="btn fw-bold btn-lg bgAdd circle ms-3"
      ...
      <div className="mt-3 p-1 boxTax">
        {tax.map((charge) => (
          <div
            className="d-inline-flex align-items-center alert alert-primary p-1 m-sm-2"
            key={charge.id}
          >
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="fs-5" id="exampleModalLabel">
                Añadir Impuesto
              </h2>
              <button
                type="button"
