...
function UserProfileComponent() {
  ...
  useEffect(() => {
    ...
    const noImageElementSmall = document.getElementById(
      "userNoProfileImageSmall"
    );
    startLoadingProfileImage(
      user.username,
      imageElement,
  ...
  function updatedUserProfileImage(event) {
    ...
    //     const imageElement = document.getElementById('userProfileImage');
    //     startUpdatingProfileImage(user.username, form, imageElement, noImageElement, imageElementSmall, noImageElementSmall)
    //     return;
    // }
          ...
          <div className="tablePane">
            ...
            >
              ...
              >
                ...
                />
                <img
                  id="userNoProfileImage"
                  src="src\assets\images\user-no-image.png"
                  alt="foto de perfil"
                  width={"100px"}
                  height={"100px"}
                />
